...
/**
 * @autheor masheng
 * @description 自定义MyKeyedProcessFunction类继承KeyedProcessFunction
 * @date 2020/4/28
 */
public class MyKeyedProcessFunction extends KeyedProcessFunction<String, MessageInfo, String> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        warningTimer = getRuntimeContext().getState(new ValueStateDescriptor<Long>("warningTimer", Long.class));
    }
